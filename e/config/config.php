...
$ecms_config['esafe']['ecookiernd']='QxL7nq7RM2dhePQ2AZFVVmkyVjdEKL';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='bujdg';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='annpw';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='wgaFw7NBDj2PL2sLQRicXnz9ZnnUpr';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='qf8CP7vYPrz5HFbhQeVRzaRpTZEfME';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
...
//------------e_public
$public_r=array('sitename'=>'大呆牛生活百科网',
'newsurl'=>'/',
...
'keytog'=>2,
'keytime'=>30,
'keyrnd'=>'LKhUH4wsnmzFbxfcaSMfjcgfYm2ewX',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/shxqm/\">生活小窍门</a>&nbsp;|&nbsp;<a href=\"/jkys/\">健康养生</a>&nbsp;|&nbsp;<a href=\"/mswh/\">民俗文化</a>&nbsp;|&nbsp;<a href=\"/xqhw/\">兴趣户外</a>&nbsp;|&nbsp;<a href=\"/zcsj/\">职场社交</a>&nbsp;|&nbsp;<a href=\"/qgxl/\">情感心灵</a>&nbsp;|&nbsp;<a href=\"/a/\">更多</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,ftitle,special.field,newstime,smalltext,newstext,titlepic,fpic,writer,befrom,',
'qenter'=>',title,ftitle,special.field,smalltext,newstext,titlepic,fpic,writer,befrom,',
'listtempf'=>',title,ftitle,newstime,smalltext,diggtop,titlepic,fpic,',
'tempf'=>',title,ftitle,newstime,smalltext,newstext,diggtop,titlepic,fpic,writer,befrom,',
'mustqenterf'=>',title,newstext,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>',title,ftitle,smalltext,',
'cj'=>',title,ftitle,newstime,smalltext,newstext,titlepic,writer,befrom,',
'canaddf'=>',title,ftitle,newstime,smalltext,newstext,titlepic,fpic,writer,befrom,',
'caneditf'=>',title,ftitle,newstime,smalltext,newstext,titlepic,fpic,writer,befrom,',
'tbmainf'=>',title,titlepic,newstime,ftitle,smalltext,diggtop,fpic,',
'tbdataf'=>',writer,befrom,newstext,',
'tobrf'=>',smalltext,newstext,',
'dohtmlf'=>',ftitle,smalltext,writer,befrom,newstext,diggtop,fpic,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',newstext,',
'ubbeditorf'=>',',
