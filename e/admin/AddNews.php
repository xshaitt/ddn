                ...
                <td>所属专题</td>
						...
						<tr> 
							<td height="25" bgcolor="#FFFFFF">
								...
								<a id="setAlt" href="javascript:void(0)">设置alt</a>
					 ...
					 */
  					...
  					$(function(){
  						...
  						var addNewsSimple=function(){
  							 this.title=$('input[name="title"]');
  							 this.alt=$('#alt');
  						}

  						addNewsSimple.prototype={
  							//自动添加alt
  							autoAlt:function(){
  								
  								var that=this;
  								this.title.bind('input propertychange',function(){
  									
  									var tmpval=$(this).val();
  									setTimeout(function(){that.setInputVal(that.alt,tmpval)},60);
  									
  								})
  								
  							},
  							//获取表单值
  							getInputVal:function(jqel){
  								if(jqel.length>0){
  									return jqel.val();
  								}
  							},
